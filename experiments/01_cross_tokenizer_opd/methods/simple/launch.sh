...
METHOD="${1:-simple}"  # default to simple, can pass "simct"
...
EXPERIMENT_DIR="/apdcephfs_cq8/share_1324356/shinejiesun/workspace/EasyOPD/experiments"
DATA_DIR="${EXPERIMENT_DIR}/01_cross_tokenizer_opd/data"
CHECKPOINT_DIR="${EXPERIMENT_DIR}/01_cross_tokenizer_opd/simple/checkpoints"
...
REWARD_FN="${EXPERIMENT_DIR}/_shared/scripts/reward_fn.py"
