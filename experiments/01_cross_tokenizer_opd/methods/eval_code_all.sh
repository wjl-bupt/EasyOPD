...
# ============================================================
# Batch Code Evaluation for all methods (MBPP + LCB-v6)
#
# Evaluates all trained checkpoints across all methods on code benchmarks.
...
N_GPUS=8
MAX_TOKENS=2048
BENCHMARKS="mbpp"  # Start with mbpp; add ",lcb" once LCB data is ready
...
MODELS=(
    ...
    "base:base_qwen25_7b_instruct:/root/workspace/models/Qwen2.5-7B-Instruct"
