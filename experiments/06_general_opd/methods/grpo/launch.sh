...
# ============================================================
# GRPO (Baseline) — Standard Reinforcement Learning (No Distillation)
#
# This is the baseline method for the 06_general_opd experiment.
# It uses standard GRPO (Group Relative Policy Optimization) with
# math reward signals only, without any teacher distillation.
#
# Pipeline:
#   1. Prepare RL prompt parquet (train.parquet / val.parquet)
#   2. (Re)start Ray
#   3. GRPO training via verl.trainer.main_ppo
...
echo "[$(date)] GRPO Baseline: grad_ckpt=${ENABLE_GRAD_CKPT}, rollout_mem=${ROLLOUT_GPU_MEM_UTIL}"
...
# ============================================================
# Step 3: GRPO Training (No Distillation)
# ============================================================
...
echo "[$(date)] ===== Step 3: GRPO Training (Baseline, No Distillation) ====="
