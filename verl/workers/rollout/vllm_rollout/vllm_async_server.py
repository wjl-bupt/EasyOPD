...
def _ensure_transformers_tokenizer_compat() -> None:
    """Patch tokenizer API drift between transformers and vLLM at runtime."""
    try:
        ...
        if not hasattr(PreTrainedTokenizerBase, "all_special_tokens_extended"):
            ...
            def all_special_tokens_extended(self):
                try:
                    special_map = getattr(self, "special_tokens_map_extended", None)
            ...
            logger.warning("Patched transformers.PreTrainedTokenizerBase.all_special_tokens_extended for vLLM compatibility")
    except Exception as exc:
        logger.warning(f"Tokenizer compatibility patch skipped: {exc}")
